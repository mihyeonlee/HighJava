...
/*
 	Singleton패턴 => 객체(인스턴스)를 한 개만 만들어지게 하는 프로그래밍 방법
 			     => 외부에서 new명령을 사용하지 못하게 동일한 객체(인스턴스)를 반복하는 클래스 
 			     
 	- Singleton 클래스를 구현하는 방법
...
public class MySingleton {
	// 자기 자신의 class의 참조값을 저장하는 멤버변수를 선언
	private static MySingleton single;
	
	// 생성자를 private으로 지정한다. 외부에서 객체생성못하게 하려고
	private MySingleton() {
