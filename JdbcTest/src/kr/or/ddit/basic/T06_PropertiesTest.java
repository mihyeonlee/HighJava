...
public class T06_PropertiesTest {
	// 외부의 properties파일을 읽어와 Properies객체로 처리하기
	...
	public static void main(String[] args) {
		...
		//프로젝트가 기본값 ./res/db.properties인데 생략됨.
		...
		try {
			...
			//key 값만 읽어와 Enumeration객체로 변환하기
			Enumeration<String> keys = (Enumeration<String>)prop.propertyNames();
			
			//key값 개수만큼 반복해서 값 출력하기
			
			//keys.hasNextElement() => 다음 포인터 위치에 자료가 있으면 true, 그렇지 않으면 false
