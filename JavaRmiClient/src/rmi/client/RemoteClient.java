 ...
 */
	public static void main(String[] args) {
		...
		try {
			...
			Registry reg = LocateRegistry.getRegistry("192.168.44.44",8888);
			...
			files[0] = new File("d:/D_Other/에스프레소.jpg"); 
			files[1] = new File("d:/D_Other/카푸치노.jpg");
			...
			for(int i=0;i<files.length;i++) {
				...
				fis.read(data); // 파일 내용을 한번에 읽어서 byte배열에 저장
